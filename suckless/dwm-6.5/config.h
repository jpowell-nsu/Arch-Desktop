...
static const char col_purple[]      = "#d300c4";
static const char col_dark_blue[]   = "#000b1e";
static const char col_blue[]        = "#123e7c";

static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { col_red, col_dark_blue, col_blue },
	[SchemeSel]  = { col_red, col_blue,  col_red  }
};
...
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_dark_blue, "-nf", col_purple, "-sb", col_blue, "-sf", col_red, NULL };
